...
应用保护箱开关:特定应用开启后，应用实现完全的业务数据保护，平台管理员不再能直接访问应用后台及查看应用敏感数据。启用后IT等其他平台管理员对该应用不可查看，适用于薪酬、算薪等涉及商业机密/敏感数据等的应用。
...
**Before**
**After**
只能整体禁用宜搭的附件下载或运行附件下载，无法按应用维度控制。

可以根据**特定网络IP区段**、**特定组织人群**、**特定宜搭应用**不同条件组合，灵活配置附件管控。

## 4、网络专线模式​

专属钉钉对网络专线提供专业的网络代理功能，和实现在身份可信的情况下，在专线及公网间进行通讯。
专属宜搭支持专属钉的“网络专线代理模式”能力。