...
2.2.1 大纲树​
大纲树可以让你更清晰来看页面的布局，你还可以通过在大纲树上对控件进行批量拖拽、批量删除双击大纲树可以更改别名，用来区分多个相同的控件点击右上角的「固定」图标，可以将大纲树面板固定在左侧按住 CMD / CTRL 键，可在大纲树上进行多选操作
...
注意【是否渲染】请参考 条件渲染 介绍；【循环】请参考 循环渲染 介绍；【渲染唯一标识】请参考 渲染唯一标识（key） 介绍；
## 3. 常见问题​
